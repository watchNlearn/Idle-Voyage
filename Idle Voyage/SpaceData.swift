...
var spaceObjects = [SpaceObject(name: "Earth", distanceInKm: 0, image: "🌎".image()!, desc: "You may know this place...", description: "Our home planet is the third planet from the Sun, and the only place we know of so far that’s inhabited by living things. While Earth is only the fifth largest planet in the solar system, it is the only world in our solar system with liquid water on the surface. Just slightly larger than nearby Venus, Earth is the biggest of the four planets closest to the Sun, all of which are made of rock and metal.", type: .planet),
                    ...
                    SpaceObject(name: "Ceres", distanceInKm: 415000000, image: "🌑".image()!, desc: "Thats no moon...", description: "Dwarf planet Ceres is the largest object in the asteroid belt between Mars and Jupiter, and it's the only dwarf planet located in the inner solar system. Covered with cryovolcanoes, Ceres's surface is a mixture of water ice and rock. It was the first member of the asteroid belt to be discovered when Giuseppe Piazzi spotted it in 1801. And when NASA's Dawn arrived in 2015, Ceres became the first dwarf planet to receive a visit from a spacecraft.", type: .other),
                    // Jupiter Moons
                    SpaceObject(name: "Callisto", distanceInKm: 625840000, image: "🌖".image()!, desc: "Secret Ocean", description: "Callisto is Jupiter’s second largest moon and the third largest moon in our solar system (about the same size as Mercury). Data from NASA’s Galileo spacecraft in the 1990s revealed Callisto may have a secret: a salty ocean beneath its surface. That finding put the once seemingly dead moon on the list of worlds that could possibly harbor life.", type: .moon),
                    
                    SpaceObject(name: "Ganymede", distanceInKm: 626560000, image: "🌑".image()!, desc: "Magnets 🧲", description: "Jupiter’s icy moon Ganymede is the largest moon in our solar system, even bigger than the planet Mercury, and the dwarf planet Pluto. There’s strong evidence that Ganymede has an underground saltwater ocean that may hold more water than all the water on Earth's surface. Ganymede is the only moon known to have its own magnetic field – something typically found on planets like Earth. The magnetic field causes auroras, or bright ribbons of glowing gas, that circle the moon’s poles.", type: .moon),
                    
                    SpaceObject(name: "Europa", distanceInKm: 628060000, image: "🌑".image()!, desc: "Ice Bath", description: "Europa is the sixth-largest moon in the Solar System and perhaps the most promising place to look for present-day environments suitable for life. Europa is thought to have an ocean of salty water below its frozen outer shell of ice.", type: .moon),
                    ...
                    SpaceObject(name: "Pluto", distanceInKm: 5890000000, image: UIImage(named: "Pluto")!, desc: "Honorary Planet", description: "Once the ninth planet from the sun, Pluto is unlike other planets in many respects. It is smaller than Earth's moon; its orbit is highly elliptical, falling inside Neptune's orbit at some points and far beyond it at others; and Pluto's orbit doesn't fall on the same plane as all the other planets —  instead, it orbits 17.1 degrees above or below. Now a dwarf planet, Pluto resides in the Kuiper Belt.", type: .other),
