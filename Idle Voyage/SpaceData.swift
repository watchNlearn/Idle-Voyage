...
var spaceObjects = [SpaceObject(name: "Earth", distanceInKm: 0, image: "🌎".image()!, desc: "You may know this place...", description: "Our home planet is the third planet from the Sun, and the only place we know of so far that’s inhabited by living things. While Earth is only the fifth largest planet in the solar system, it is the only world in our solar system with liquid water on the surface. Just slightly larger than nearby Venus, Earth is the biggest of the four planets closest to the Sun, all of which are made of rock and metal.", type: .planet),
                    ...
                    // Mars Moons
                    SpaceObject(name: "Phobos", distanceInKm: 77795600, image: "🌑".image()!, desc: "The Martian Moon", description: "The Martian moon Phobos orbits only a few thousand miles above the Red Planet's surface. Its proximity to its planet is one of the reasons astronomers were unable to see the satellite until the late 19th century. In fact, the moon is getting closer to Mars and over the centuries will eventually either break up or be pulled into the Martian surface.", type: .moon),
                    SpaceObject(name: "Deimos", distanceInKm: 78316540, image: "🌑".image()!, desc: "The other Martian Moon", description: "Deimos is the smaller of Mars' two moons and whirls around Mars every 30 hours. Deimos is a small lumpy and heavily cratered object with most of its craters ranging only in 2.5km in diameter. Unlike Phobos, Deimos will eventually break from Mars' gravitational pull and fly into outer space.", type: .moon),
                    ...
                    // The Sun
                    SpaceObject(name: "Sun", distanceInKm: 150000000, image: "☀️".image()!, desc: "Bring any sunscreen?", description: "Our Sun is a 4.5 billion-year-old star – a hot glowing ball of hydrogen and helium at the center of our solar system. The Sun is about 93 million miles (150 million kilometers) from Earth, and without its energy, life as we know it could not exist here on our home planet. The Sun is the largest object in our solar system. The Sun’s volume would need 1.3 million Earths to fill it. Its gravity holds the solar system together, keeping everything from the biggest planets to the smallest bits of debris in orbit around it.", type: .star),
                    
                    // Belt Objects
                    SpaceObject(name: "Eros", distanceInKm: 315000000, image: "🪨".image()!, desc: "1st NEA!", description: "Eros is famous as the first asteroid to be orbited by a spacecraft, and the first asteroid to have a spacecraft land on it. But Eros was important to astronomers as far back as 1898 when it became the first near-Earth asteroid (NEA) to be discovered.", type: .asteroid),
                    
                    SpaceObject(name: "Vesta", distanceInKm: 412146000, image: "🪨".image()!, desc: "9%", description: "Vesta is the second most massive body in the main asteroid belt, accounting for almost nine percent of the total mass of all asteroids. Only dwarf planet Ceres is more massive in that region of rocky debris between Mars and Jupiter. NASA’s Dawn spacecraft circled Vesta from July 16, 2011 until Sept. 5, 2012, when it departed and began its journey to dwarf planet Ceres.", type: .asteroid),
                    
                    SpaceObject(name: "Ceres", distanceInKm: 413000000, image: "🌑".image()!, desc: "Thats no moon...", description: "Dwarf planet Ceres is the largest object in the asteroid belt between Mars and Jupiter, and it's the only dwarf planet located in the inner solar system. It was the first member of the asteroid belt to be discovered when Giuseppe Piazzi spotted it in 1801. And when NASA's Dawn arrived in 2015, Ceres became the first dwarf planet to receive a visit from a spacecraft.", type: .other),
                    // Jupiter Moons
                    SpaceObject(name: "Callisto", distanceInKm: 626847000, image: "🌖".image()!, desc: "3rd Place", description: "Callisto is Jupiter’s second largest moon and the third largest moon in our solar system (about the same size as Mercury). Data from NASA’s Galileo spacecraft in the 1990s revealed Callisto may have a secret: a salty ocean beneath its surface. That finding put the once seemingly dead moon on the list of worlds that could possibly harbor life.", type: .moon),
                    
                    SpaceObject(name: "Europa", distanceInKm: 628059000, image: "🌑".image()!, desc: "Icy Sea", description: "Europa is perhaps the most promising place to look for present-day environments suitable for life. Europa is thought to have an ocean of salty water below its frozen outer shell of ice.", type: .moon),
                    
                    SpaceObject(name: "Io", distanceInKm: 628280000, image: "🌕".image()!, desc: "The floor is lava!", description: "Jupiter's moon Io is the most volcanically active world in the Solar System, with hundreds of volcanoes, some erupting lava fountains dozens of miles (or kilometers) high. Io is caught in a tug-of-war between Jupiter's massive gravity and the smaller but precisely timed pulls from two neighboring moons that orbit farther from Jupiter—Europa and Ganymede.", type: .moon),
